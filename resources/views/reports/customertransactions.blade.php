          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">CUSTOMER TRANSACTIONS</h6>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">QUANTITY BOUGHT</th>
                      ...
                      @foreach ($users as $u )
                        <tr>
                            ...
                            <td>
                              <div class="px-2">
                                <div class="my-auto">
                                  <h6 class="mb-0 text-sm">{{ "$u->productbought" }}</h6>
                                </div>
                              </div>
                                {{-- {{ "$u->productbought" }} --}}
                            </td>
                            ...
                            <td>
                              <div class="px-2">
                                <div class="my-auto">
                                  <h6 class="mb-0 text-sm"> {{ "$u->totalprice" }}</h6>
                                </div>
                              </div>
                            </td>
                            <td>
